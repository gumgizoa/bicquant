...
_ERROR_CODES = {
    ...
    "014": "파일이 존재하지 않습니다",
    "020": (
        "요청 제한을 초과하였습니다. 일반적으로는 20,000건 이상의 요청에 대하여 이 에러 메시지가 발생되나,"
...
def raise_for_dart_status(data: dict) -> None:
    """Raise APIError if DART JSON response contains a non-zero status code."""
